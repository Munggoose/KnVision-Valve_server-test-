...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--nz', type=int, default=700, help='size of the latent z vector')
        self.parser.add_argument('--ngf', type=int, default=124)#64
        self.parser.add_argument('--ndf', type=int, default=124)
        self.parser.add_argument('--extralayers', type=int, default=2, help='Number of extra layers on gen and disc')#1
        ...
        ##
        # Train
        self.parser.add_argument('--print_freq', type=int, default=100, help='frequency of showing training results on console')#100
        # self.parser.add_argument('--save_image_freq', type=int, default=50, help='frequency of saving real and fake images')#100
        self.parser.add_argument('--save_image_freq', type=int, default=2, help='frequency of saving real and fake images')#100
