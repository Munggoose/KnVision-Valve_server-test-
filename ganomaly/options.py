...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # custom
        self.parser.add_argument('--mod', default='all', help='all | onebyone')

        ##
        # Base
        self.parser.add_argument('--dataset', default='none', help='folder | cifar10 | mnist | none')
        ...
        self.parser.add_argument('--nz', type=int, default=400, help='size of the latent z vector')
        ...
        ##
        # Train
        self.parser.add_argument('--print_freq', type=int, default=4, help='frequency of showing training results on console') ##
        self.parser.add_argument('--save_image_freq', type=int, default=4, help='frequency of saving real and fake images') ##
