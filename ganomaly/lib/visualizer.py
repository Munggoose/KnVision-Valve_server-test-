...
class Visualizer():
    ...
    def __init__(self,opt):
        ...
        #Discriminator for plotting data and results
        self.plot_data = None
        self.plot_res = None
        ...
        with open(self.log_name,"a") as log_files:
            now = time.strftime("%c")
            log_files.write('==================== Training Loss (%s)==================\n' % now) 
    ...
    def plot_current_errors(self,epoch, counter_ratio, errors):
        ...
        Args:
            ...
            errors (OrderDict): Error for the current epoch.
        """
