...
def load_data(opt):
    ...
    if opt.dataset in ['casting']:
        ...
        dset = {'train': Castingdataset(root='data', train = True),  'test': Castingdataset(root='data', train = False)}
        dataloader = {x: torch.utils.data.DataLoader(dataset=dset[x],
                                                     batch_size=opt.batchsize,
                                                     shuffle=shuffle[x],
                                                     num_workers=int(opt.workers),
                                                     drop_last=drop_last_batch[x],
